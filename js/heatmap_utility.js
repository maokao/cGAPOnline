...
function changeRowOrder(newOrder, heatmapId) {
    ...
    if (newOrder == "r2e" || newOrder == "singlelinkage" || newOrder == "averagelinkage" || newOrder == "completelinkage" || newOrder == "random") { 
        ...
        svg.select("#mv20").selectAll(".row")
                ...
                .attr("transform", function(d, i) {
                    var row = parseInt(d3.select(this).attr("id"));
                    var temp_x = $("#mv20")[0].getAttribute("x");
            ...
            .attr("transform", function(d, i) {
                ...
                else
                {
                    if(yd>0)
                        ...
                        return "translate("+(-3+albxx_X)+"," + ycov_cellHeight / 1.5 + ")";
                }
            });
...
function changeColOrder(newOrder, heatmapId) {
    ...
    //var t = svg.transition().duration(1000);
    if (newOrder == "r2e" || newOrder == "singlelinkage" || newOrder == "averagelinkage" || newOrder == "completelinkage" || newOrder == "random") { 
        var tree_y = (-10-col_number*cellWidth)+albcat_Y;
        ...
        svg.select("#mv21").selectAll(".cell")
            .attr("x", function(d) {
                var col = parseInt(d3.select(this).attr("col"));
                return sorted.indexOf(col) * xcov_cellWidth;
            })
        svg.select("#mv21").selectAll(".row")
            .attr("transform", function(d, i) {
                var row = parseInt(d3.select(this).attr("id"));
                var temp_x = $("#mv21")[0].getAttribute("x");
                var temp_y = (hml_maxcat-i-1) * xcov_cellHeight + albcat_Y;
        ...
        if(!isColProxfirst)
        {
            ...
            svg.select("#mv3").selectAll(".row")
                ...
                .attr("transform", function(d, i) {
                    ...
                    var temp_y = sorted.indexOf(row) * cellWidth-10-col_number*cellWidth+albcat_Y;
            ...
            svg.selectAll(".colLabel")
                ...
                .attr("transform", function(d, i) {
                    var temp_y = -10-col_number*cellWidth+cellWidth / 1.5+albcat_Y;
                    if(xc>0)
                    {
                        if(xd>0)
                            temp_y = temp_y + (-5+xd_Y);
        ...
        if(!isColProxfirst)
        {
            ...
            svg.select("#mv3").selectAll(".row")
                ...
                .attr("transform", function(d, i) {
                    var row = parseInt(d3.select(this).attr("id"));
                    var temp_x = $("#mv3")[0].getAttribute("x");
                    var temp_y = row * cellWidth-10-col_number*cellWidth+albcat_Y;
...
function changeOrder(newOrder, heatmapId) {
    ...
    if (newOrder == "sortinit_col") { // initial sort on cols (alphabetically if produced like this)
        ...
        t.select("#mv21").selectAll(".cell")
            .attr("x", function(d) {
                var col = parseInt(d3.select(this).attr("col"));
                return col * xcov_cellWidth;
            })
        t.select("#mv21").selectAll(".row")
            .attr("transform", function(d, i) {
                var row = parseInt(d3.select(this).attr("id"));
                var temp_x = $("#mv21")[0].getAttribute("x");
                var temp_y = (hml_maxcat-i-1) * xcov_cellHeight + albcat_Y;
            ...
            .attr("transform", function(d, i) {
                ...
                else
                {
                    if(yd>0)
                        ...
                        return "translate("+(-3+albxx_X)+"," + cellHeight / 1.5 + ")";
                }
            });
...
function changePalette(conditionName, paletteName, heatmapId) {
    ...
    if(optionTargetDataMap == "rawdata")
    {
        ...
        if(conditionName == "RangeMatrix")
        {
            ...
            //$("#rgbcube_xx").css("background-color")
            var svg = d3.select(heatmapId);
            ...
            t.select("#mv").selectAll(".cell")
                .style("fill", function(d) {
                    if(paletteName == "cGAP")
                    {
                        ...
                        var nowrownum = parseInt(rownum)+1;
                        var nowcolnum = parseInt(colnum)+1;
                        var RGB_R=255;
                        var RGB_G=255;
                        var RGB_B=255;
                        if($("#rgbcube_xx").attr("name")=="rgbcube_r")
                            RGB_R = 128+128*rgbcube_x*albyyr[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[0]);
                        else if($("#rgbcube_xx").attr("name")=="rgbcube_g")
                            RGB_G = 128+128*rgbcube_x*albyyr[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[0]);
                        else if($("#rgbcube_xx").attr("name")=="rgbcube_b")
                            RGB_B = 128+128*rgbcube_x*albyyr[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[0]);
                        if($("#rgbcube_yy").attr("name")=="rgbcube_g")
                            RGB_G = 128+128*rgbcube_y*albyyg[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[1]);
                        else if($("#rgbcube_yy").attr("name")=="rgbcube_r")
                            RGB_R = 128+128*rgbcube_y*albyyg[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[1]);
                        else if($("#rgbcube_yy").attr("name")=="rgbcube_b")
                            RGB_B = 128+128*rgbcube_y*albyyg[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[1]);
                        if($("#rgbcube_zz").attr("name")=="rgbcube_b")
                            RGB_B = 128+128*rgbcube_z*albyyb[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[2]);
                        else if($("#rgbcube_zz").attr("name")=="rgbcube_r")
                            RGB_R = 128+128*rgbcube_z*albyyb[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[2]);
                        else if($("#rgbcube_zz").attr("name")=="rgbcube_g")
                            RGB_G = 128+128*rgbcube_z*albyyb[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[2]);
                        if(RGB_R>255)
                            RGB_R=255;
                        if(RGB_G>255)
                            RGB_G=255;
                        ...
                        if (d != null) 
                        {
                            ...
                            {  
                                if(d==missing_value)
                                    ...
                                    return d3.rgb(RGB_R,RGB_G,RGB_B); 
                            }
                        ...
                        return colorScale(d); //for user other color spectrum.  
                });
            //if(d3.select("#md_colorspec").select("svg").selectAll(".cellLegend").size()==0)
            //{}
            //else{
            ...
            /*
                    var nowrownum = parseInt(rownum)+1;
                    var nowcolnum = parseInt(colnum)+1;
                    //console.log("albyyr[rownum+1][colnum+1]:"+nowrownum+","+nowcolnum+",");
                    var RGB_R = 128+128*albyyr[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[0]);
                    var RGB_G = 128+128*albyyg[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[1]);
                    var RGB_B = 128+128*albyyb[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[2]);
                    if(RGB_R>255)
                        RGB_R=255;
                    if(RGB_G>255)
                        RGB_G=255;
                ...
                .style("fill", function(d) {
                    ...
                    if(data_row_min_value[rownum]<minInputRange2)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if(paletteName == "GAP_Rainbow")
                                    colorScale = GAP_Rainbow(minInputRange2, data_row_max_value[rownum]);
                                else if(paletteName == "GAP_Blue_White_Red")
                                    colorScale = GAP_Blue_White_Red(minInputRange2, data_row_max_value[rownum]);
                                else
                                colorScale = d3.scaleSequential()
                            ...
                            {
                                if(paletteName == "GAP_Rainbow")
                                    colorScale = GAP_Rainbow(data_row_max_value[rownum], minInputRange2);
                                else if(paletteName == "GAP_Blue_White_Red")
                                    colorScale = GAP_Blue_White_Red(data_row_max_value[rownum], minInputRange2);
                                else
                                    colorScale = d3.scaleSequential()
                    ...
                    else
                    {
                        if(data_row_max_value[rownum]>maxInputRange2)
                        {
                            ...
                            {
                                if(paletteName == "GAP_Rainbow")
                                    colorScale = GAP_Rainbow(data_row_min_value[rownum], maxInputRange2);
                                else if(paletteName == "GAP_Blue_White_Red")
                                    colorScale = GAP_Blue_White_Red(data_row_min_value[rownum], maxInputRange2);
                                else
                                    colorScale = d3.scaleSequential()
                            ...
                            {
                                if(paletteName == "GAP_Rainbow")
                                    colorScale = GAP_Rainbow(maxInputRange2, data_row_min_value[rownum]);
                                else if(paletteName == "GAP_Blue_White_Red")
                                    colorScale = GAP_Blue_White_Red(maxInputRange2, data_row_min_value[rownum]);
                                else
                                colorScale = d3.scaleSequential()
                        ...
                        else
                        {
                            ...
                            {
                                if(paletteName == "GAP_Rainbow")
                                    colorScale = GAP_Rainbow(data_row_max_value[rownum], data_row_min_value[rownum]);
                                else if(paletteName == "GAP_Blue_White_Red")
                                    colorScale = GAP_Blue_White_Red(data_row_max_value[rownum], data_row_min_value[rownum]);
                                else
                                    colorScale = d3.scaleSequential()
                ...
                .style("fill", function(d) {
                    ...
                    if(data_min_value[colnum]<minInputRange2)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if(paletteName == "GAP_Rainbow")
                                    colorScale = GAP_Rainbow(minInputRange2, data_max_value[colnum]);
                                else if(paletteName == "GAP_Blue_White_Red")
                                    colorScale = GAP_Blue_White_Red(minInputRange2, data_max_value[colnum]);
                                else
                                    colorScale = d3.scaleSequential()
                            ...
                            {
                                if(paletteName == "GAP_Rainbow")
                                    colorScale = GAP_Rainbow(data_max_value[colnum], minInputRange2);
                                else if(paletteName == "GAP_Blue_White_Red")
                                    colorScale = GAP_Blue_White_Red(data_max_value[colnum], minInputRange2);
                                else
                                    colorScale = d3.scaleSequential()
                    ...
                    else
                    {
                        if(data_max_value[colnum]>maxInputRange2)
                        {
                            ...
                            {
                                if(paletteName == "GAP_Rainbow")
                                    colorScale = GAP_Rainbow(data_min_value[colnum], maxInputRange2);
                                else if(paletteName == "GAP_Blue_White_Red")
                                    colorScale = GAP_Blue_White_Red(data_min_value[colnum], maxInputRange2);
                                else
                                    colorScale = d3.scaleSequential()
                            ...
                            {
                                if(paletteName == "GAP_Rainbow")
                                    colorScale = GAP_Rainbow(maxInputRange2, data_min_value[colnum]);
                                else if(paletteName == "GAP_Blue_White_Red")
                                    colorScale = GAP_Blue_White_Red(maxInputRange2, data_min_value[colnum]);
                                else
                                colorScale = d3.scaleSequential()
                        ...
                        else
                        {
                            ...
                            {
                                if(paletteName == "GAP_Rainbow")
                                    colorScale = GAP_Rainbow(data_min_value[colnum], data_max_value[colnum]);
                                else if(paletteName == "GAP_Blue_White_Red")
                                    colorScale = GAP_Blue_White_Red(data_min_value[colnum], data_max_value[colnum]);
                                else
                                    colorScale = d3.scaleSequential()
                            ...
                            {
                                if(paletteName == "GAP_Rainbow")
                                    colorScale = GAP_Rainbow(data_max_value[colnum], data_min_value[colnum]);
                                else if(paletteName == "GAP_Blue_White_Red")
                                    colorScale = GAP_Blue_White_Red(data_max_value[colnum], data_min_value[colnum]);
                                else
                                colorScale = d3.scaleSequential()
...
function redrawHeatmap(nowID, x, y, mode, heatmapId) {
        ...
        row.attr("transform", function(d, i) {
                ...
                {
                    return "translate(" + 0 + "," + ((hml_maxcat-i-1) * xcov_cellHeight + albcat_Y) + ")"; 
                }      
                else if(mode == 1)  //rp
                {
                    var row = parseInt(d3.select(this).attr("id"));
...
function changeWidth(widthZoomRange, heatmapId) {
    ...
    if(optionTargetDataMap == "rawdata")
    {
        ...
        redrawHeatmap("mv21", 0, albcat_Y, 21, heatmapId);
        ...
        if(!isColProxfirst)
        {
            var temp_y = (-10-col_number*cellWidth)+albcat_Y;
            if(xc>0)
            {
                if(xd>0)
                    temp_y = temp_y + (-5+xd_Y);
            ...
            if (colOrderId == "singlelinkage" || colOrderId == "averagelinkage" || colOrderId == "completelinkage") 
            {
                ...
                changeTreePosition("colTree", col_number*cellWidth+5+d3.selectAll('.colLabels').node().getBBox().width, temp_y, heatmapId);
            }
...
function changeHeight(heightZoomRange, heatmapId) {
    ...
    if(optionTargetDataMap == "rawdata")
    {
        ...
        var mode = 0;
        redrawHeatmap("mv", 0, 0, 99, heatmapId);
        redrawHeatmap("mv20", albxx_X, 0, 20, heatmapId);
       // redrawHeatmap("mv21", 0, albcat_Y, 21, heatmapId);
...
//#########################################################
function setupHeatmap_albxx(nowdata, nowID, x, y, heatmapId) {
        ...
        var heatMap = row.selectAll(".cell")
            ...
            .style("fill", function(d) {
                ...
                var nowrownum = parseInt(rownum)+1;
                var RGB_R = 128+128*albxx[nowrownum][1]/Math.abs(maxrgbvalue[0]);
                var RGB_G = 128+128*albxx[nowrownum][2]/Math.abs(maxrgbvalue[1]);
                var RGB_B = 128+128*albxx[nowrownum][3]/Math.abs(maxrgbvalue[2]);
                if(RGB_R>255)
                        RGB_R=255;
                if(RGB_G>255)
                        RGB_G=255;
...
//#########################################################
function setupHeatmap_albcat(nowdata, nowID, x, y, heatmapId) {
        var svg = d3.select(heatmapId).select("svg").select("#gap");
        var mv = svg.append("g")
            .attr("id", nowID)
            .attr("class", nowID)
            ...
            .attr("transform", function(d, i) {
                    return "translate(" + 0 + "," + ((hml_maxcat-i-1)* xcov_cellHeight+y) + ")"; 
            })
            .attr("class", "row");
        var row = svg.select("#"+nowID).selectAll(".row");
        ...
        var heatMap = row.selectAll(".cell")
            ...
            .style("fill", function(d) {
                ...
                var nowrownum = parseInt(rownum);
                var nowcolnum = parseInt(colnum); 
                if(d!=missing_value)
                {
                    //if(albcat[nowrownum*hml_maxcat+nowcolnum+1][1]==0 && albcat[nowrownum*hml_maxcat+nowcolnum+1][2]==0 && albcat[nowrownum*hml_maxcat+nowcolnum+1][3]==0)
                    if(albcat_R[nowrownum][nowcolnum]==0 && albcat_G[nowrownum][nowcolnum]==0 && albcat_B[nowrownum][nowcolnum]==0)
                    {
                        return d3.rgb(255,255,255,0);  
                    }
                    else
                    {
                        var RGB_R = 128+128*albcat_R[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[0]);
                        var RGB_G = 128+128*albcat_G[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[1]);
                        var RGB_B = 128+128*albcat_B[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[2]);
                        if(RGB_R>255)
                                RGB_R=255;
                        if(RGB_G>255)
                                RGB_G=255;
...
//#########################################################
function redrawHeatmap_albxx(heatmapId) {
        var svg = d3.select(heatmapId);
        var t = svg.transition().duration(500);
        t.select("#mv20").selectAll(".cell")
            .style("fill", function(d) {
                var colnum = d3.select(this).attr("col");
                var rownum = d3.select(this).attr("row");
                ...
                //var RGB_B = 128+128*albxx[nowrownum][3]/Math.abs(maxrgbvalue[2]);
                if($("#rgbcube_xx").attr("name")=="rgbcube_r")
                    RGB_R = 128+128*rgbcube_x*albxx[nowrownum][1]/Math.abs(maxrgbvalue[0]);
                else if($("#rgbcube_xx").attr("name")=="rgbcube_g")
                    RGB_G = 128+128*rgbcube_x*albxx[nowrownum][1]/Math.abs(maxrgbvalue[0]);
                else if($("#rgbcube_xx").attr("name")=="rgbcube_b")
                    RGB_B = 128+128*rgbcube_x*albxx[nowrownum][1]/Math.abs(maxrgbvalue[0]);
                if($("#rgbcube_yy").attr("name")=="rgbcube_g")
                    RGB_G = 128+128*rgbcube_y*albxx[nowrownum][2]/Math.abs(maxrgbvalue[1]);
                else if($("#rgbcube_yy").attr("name")=="rgbcube_r")
                    RGB_R = 128+128*rgbcube_y*albxx[nowrownum][2]/Math.abs(maxrgbvalue[1]);
                else if($("#rgbcube_yy").attr("name")=="rgbcube_b")
                    RGB_B = 128+128*rgbcube_y*albxx[nowrownum][2]/Math.abs(maxrgbvalue[1]);
                if($("#rgbcube_zz").attr("name")=="rgbcube_b")
                    RGB_B = 128+128*rgbcube_z*albxx[nowrownum][3]/Math.abs(maxrgbvalue[2]);
                else if($("#rgbcube_zz").attr("name")=="rgbcube_r")
                    RGB_R = 128+128*rgbcube_z*albxx[nowrownum][3]/Math.abs(maxrgbvalue[2]);
                else if($("#rgbcube_zz").attr("name")=="rgbcube_g")
                    RGB_G = 128+128*rgbcube_z*albxx[nowrownum][3]/Math.abs(maxrgbvalue[2]);
                if(RGB_R>255)
                        RGB_R=255;
                if(RGB_G>255)
                        RGB_G=255;
...
//#########################################################
function redrawHeatmap_albcat(heatmapId) {
        var svg = d3.select(heatmapId);
        var t = svg.transition().duration(500);
        t.select("#mv21").selectAll(".cell")
            .style("fill", function(d) {
                ...
                if(d!=missing_value)
                {
                    ...
                    {
                        //var RGB_R = 128+128*rgbcube_x*albcat_R[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[0]);
                        //var RGB_G = 128+128*rgbcube_y*albcat_G[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[1]);
                        //var RGB_B = 128+128*rgbcube_z*albcat_B[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[2]);
                        var RGB_R = 255;
                        var RGB_G = 255;
                        var RGB_B = 255;
                        if($("#rgbcube_xx").attr("name")=="rgbcube_r")
                            RGB_R = 128+128*rgbcube_x*albcat_R[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[0]);
                        else if($("#rgbcube_xx").attr("name")=="rgbcube_g")
                            RGB_G = 128+128*rgbcube_x*albcat_R[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[0]);
                        else if($("#rgbcube_xx").attr("name")=="rgbcube_b")
                            RGB_B = 128+128*rgbcube_x*albcat_R[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[0]);
                        if($("#rgbcube_yy").attr("name")=="rgbcube_g")
                            RGB_G = 128+128*rgbcube_y*albcat_G[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[1]);
                        else if($("#rgbcube_yy").attr("name")=="rgbcube_r")
                            RGB_R = 128+128*rgbcube_y*albcat_G[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[1]);
                        else if($("#rgbcube_yy").attr("name")=="rgbcube_b")
                            RGB_B = 128+128*rgbcube_y*albcat_G[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[1]);
                        if($("#rgbcube_zz").attr("name")=="rgbcube_b")
                            RGB_B = 128+128*rgbcube_z*albcat_B[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[2]);
                        else if($("#rgbcube_zz").attr("name")=="rgbcube_r")
                            RGB_R = 128+128*rgbcube_z*albcat_B[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[2]);
                        else if($("#rgbcube_zz").attr("name")=="rgbcube_g")
                            RGB_G = 128+128*rgbcube_z*albcat_B[nowrownum][nowcolnum]/Math.abs(maxrgbvalue[2]);
                        if(RGB_R>255)
                                RGB_R=255;
                        if(RGB_G>255)
                                RGB_G=255;
...
//#########################################################
function redrawRawData(heatmapId) {
...
function setupHeatmap2(nowdata, nowID, x, y, mode, heatmapId, colorID) {
        ...
        */
            ...
            if(optionTargetDataMap == "rawdata" && rdPaletteReverse)
            {
                let paletteName;
                if(mode == 0)
                    paletteName = rwPalette;
                else if(mode==1)
                    paletteName = rpPalette;
                else if(mode==2)
                    paletteName = cpPalette;
                
                if(paletteName == "GAP_Rainbow")
                    colorScale = GAP_Rainbow(min_data, max_data);
                else if(paletteName == "GAP_Blue_White_Red")
                    colorScale = GAP_Blue_White_Red(min_data, max_data);
                else
                    colorScale = d3.scaleSequential()
                    .domain([min_data, max_data])
                    .interpolator(colorID);  
...
function changeColLabelsPosition(heatmapId, col_number) {
    ...
    svg.selectAll(".colLabel")
        ...
        .attr("transform", function(d, i) {
                ...
                var temp_y = albcat_Y-10-col_number*cellWidth+cellWidth / 1.5;
                if(xc>0)
                {
                    if(xd>0)
                        temp_y = temp_y + (-5+xd_Y);
...
//console.log(svgId+","+viewerPosTop+","+colorScale+","+displayText+","+minValue+","+maxValue+","+isDiscrete);
...
function loadExample(filename) {
    ...
    else if(filename == "adult-stretch")
    {
        ...
        removeAllColorLegend();
        var sep = "\t";
        var dataFileName = "data/adult-stretch_cGAP.txt";   
        setAllParameters(dataFileName, false, true, 1, 0, 0, 0);
        heatmap_display(dataFileName, "#heatmap", "cGAP", sep); 
    }
    else if(filename == "adult+stretch")
    {
    ...
    else if(filename == "audiology")
    {
        resetAllParameters("#heatmap");
        removeAllColorLegend();
        var sep = "\t";
        var dataFileName = "data/audiology_standardized_data_cGAP.txt";   
        setAllParameters(dataFileName, false, true, 1, 0, 0, 0);
        heatmap_display(dataFileName, "#heatmap", "cGAP", sep); 
    }
    else if(filename == "balance")
    {
        ...
        removeAllColorLegend();
        var sep = "\t";
        var dataFileName = "data/balance-scale_cGAP.txt";   
        setAllParameters(dataFileName, true, true, 1, 0, 0, 0);
        heatmap_display(dataFileName, "#heatmap", "cGAP", sep); 
    }
    else if(filename == "breast-cancer")
    {
        resetAllParameters("#heatmap");
        removeAllColorLegend();
        var sep = "\t";
        var dataFileName = "data/breast-cancer_cGAP.txt";   
        setAllParameters(dataFileName, false, true, 1, 0, 0, 0);
        heatmap_display(dataFileName, "#heatmap", "cGAP", sep); 
    }
